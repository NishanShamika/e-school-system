...
export class TeacherImageService {
  ...
  private _getImageUrl = "http://localhost:3000/api/teacherImageList";
  private _searchUrl = "http://localhost:3000/api/teacherImage/";
  private _updateUrl = "http://localhost:3000/api/teacherImageUpdate/";
