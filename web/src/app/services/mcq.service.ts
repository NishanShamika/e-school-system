...
export class McqService {
  ...
  reportMcq(mcqId : string) : Observable<any> {
    let requestBody = {
      id : mcqId
    }
    return this.http.patch(`http://localhost:3000/mcq/mcq-report`, requestBody);
  }

  getReportedMcq() : Observable<any>{
    return this.http.get('http://localhost:3000/mcq/mcq-reported');
  }
