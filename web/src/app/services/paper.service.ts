...
export class PaperService {
  ...
  addPastpaper(name: string,lessonname:string,grade :string, pastpaper: Blob): void {
    const pastpaperData = new FormData();
    pastpaperData.append("name", name);
    pastpaperData.append("lessonname", lessonname);
    pastpaperData.append("grade", grade);
    pastpaperData.append("pastpaper", pastpaper);
    this.http
...
deleteGrade07(_id :any){
 ...
 private _searchUrl = "http://localhost:3000/papers/papers/";
 searchPaper(name:any){
  return this.http.get<any>(this._searchUrl+ name)
}
private _searchUrl07 = "http://localhost:3000/papers/papers07/";
searchPaper07(name:any){
 return this.http.get<any>(this._searchUrl07+ name)
}
private _searchUrl08 = "http://localhost:3000/papers/papers08/";
searchPaper08(name:any){
 return this.http.get<any>(this._searchUrl08+ name)
}
private _searchUrl09 = "http://localhost:3000/papers/papers09/";
searchPaper09(name:any){
 return this.http.get<any>(this._searchUrl09+ name)
}
private _searchUrl10 = "http://localhost:3000/papers/papers10/";
searchPaper10(name:any){
 return this.http.get<any>(this._searchUrl10+ name)
}
private _searchUrl11 = "http://localhost:3000/papers/papers11/";
searchPaper11(name:any){
 return this.http.get<any>(this._searchUrl11+ name)
}
