...
export class VideoService {
  ...
  addProfile(subjectname:string ,name: string,des: string, video: Blob,insertgrade:string): void {     /////////////////
...
deleteVideo7(_id :any){
 ...
 private _searchUrl = "http://localhost:3000/video/video06/";
 searchVideo06(videoname:any){
  return this.http.get<any>(this._searchUrl+ videoname)
}
private _searchUrl07 = "http://localhost:3000/video/video07/";
searchVideo07(videoname:any){
 return this.http.get<any>(this._searchUrl07+ videoname)
}
private _searchUrl08 = "http://localhost:3000/video/video08/";
searchVideo08(videoname:any){
 return this.http.get<any>(this._searchUrl08+ videoname)
}
private _searchUrl09 = "http://localhost:3000/video/video09/";
searchVideo09(videoname:any){
 return this.http.get<any>(this._searchUrl09+ videoname)
}
private _searchUrl10 = "http://localhost:3000/video/video10/";
searchVideo10(videoname:any){
 return this.http.get<any>(this._searchUrl10+ videoname)
}
private _searchUrl11 = "http://localhost:3000/video/video11/";
searchVideo11(videoname:any){
 return this.http.get<any>(this._searchUrl11+ videoname)
}
